    ...
    <Container>
      <StyledEducation id="education">
        ...
        <StyledEducationGrid as={motion.div} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          ...
          <EducationPlace animationOrder={3} position={"learnjs"} title={"learn javascript"} description={"Изучал теорию об особенностях и устройстве JavaScript, DOM, работе браузеров и их движков."}/>
